...
if(isset($_GET['isbn']) && isset($_GET['delete'])){
    $result = mysqli_query($link, "DELETE FROM LibraryItem WHERE isbn_code='" . $_GET['isbn'] . "'");
}
...
while($row = mysqli_fetch_array($result)) {             
    ...
    echo "<td><a href='/update_book.php?isbn=" . $row['ISBN_code'] . "'>Update</a></td>";
    echo "<td><a href='/get_books.php?isbn=" . $row['ISBN_code'] . "&delete=true'>Delete</a></td>";
    echo "</tr>";  
}   
